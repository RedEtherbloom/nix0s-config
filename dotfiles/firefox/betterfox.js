...
user_pref("browser.cache.disk.capacity", 4096000); // default=256000; size of disk cache
user_pref("browser.cache.disk.max_entry_size", 51200); // DEFAULT (50 MB); maximum size of an object in disk cache
user_pref("browser.cache.memory.capacity", 512000); // DEFAULT; 256000=256 MB; 512000=500 MB; 1048576=1GB, 2097152=2GB
user_pref("browser.cache.memory.max_entry_size", 10240); // (10 MB); default=5120 (5 MB)

// For our slow internet:
...
// Most privacy problematic, but we need the speed
user_pref("network.predictor.enabled", true); 
user_pref("network.predictor.enable-prefetch", true); // DEFAULT = false
user_pref("network.predictor.enable-hover-on-ssl", false); // DEFAULT = false

// OVERRIDES: SECUREFOX
// Current issue with strict: https://github.com/yokoffing/Betterfox/releases/tag/133.0
user_pref("browser.contentblocking.category", "standard"); 

// OCSP may slow down browsing, but it's okay for now

// Disabled due to speed implications, although murky security wise
...
// Would this disable emojis in URLs?
// user_pref("network.IDN_show_punycode", true);
