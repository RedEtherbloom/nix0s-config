  ...
  config = mkIf cfg.enable {
    programs.nvf = {
      ...
      settings.vim = {
        ...
        # Copied and modified from https://www.reddit.com/r/neovim/comments/1f7nkbe/comment/lle1nbc/?utm_source=share&utm_medium=web3x&utm_name=web3xcss&utm_term=1&utm_content=sha
        luaConfigRC.telescopeMultiSelect = ''
