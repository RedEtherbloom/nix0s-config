...
in {
  ...
  config = lib.mkMerge [
    ...
    (generate-kscreen-doctor "screen-dual" "kscreen-doctor output.HDMI-A-1.disable output.DP-2.enable output.DP-2.position.1920,0 output.DP-2.priority.1 output.DP-2.rotation.normal output.DP-3.enable output.DP-3.rotation.inverted output.DP-3.position.0,0" "ctrl+shift+f2")
    ...
    (generate-kscreen-doctor "screen-trial" "kscreen-doctor output.DP-2.enable output.DP-2.position.1920,0 output.DP-2.priority.1 output.DP-2.rotation.normal output.DP-3.enable output.DP-3.rotation.inverted output.DP-3.position.0,0 output.DP-3.priority.2 output.HDMI-A-1.enable output.HDMI-A-1.position.3840,0 output.HDMI-A-1.rotation.normal output.HDMI-A-1.priority.3" "ctrl+shift+f6")
  ];
}
