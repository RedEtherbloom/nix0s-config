...
in {
  ...
  config = lib.mkMerge [
    ...
    (generate-kscreen-doctor "screen-dual" "kscreen-doctor output.HDMI-A-1.disable output.DP-2.enable output.DP-2.position.1080,420 output.DP-2.priority.1 output.DP-2.rotation.right output.DP-3.enable output.DP-3.rotation.inverted output.DP-3.position.0,0" "ctrl+shift+f2")
